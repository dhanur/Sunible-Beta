...
<div class="page dashboard" id="page-dashboard" data-page="dashboard">
	...
	<section class="providers number_of_selected">
		<div class="block">
			<p>
				You have selected<br /> <span
					class="counter selected providers number"
					id="dashboard-block-number_of_providers_selected">0</span> <br />
				providers
			</p>
		...
		<button type="button"
			...
			class="btn open_registration_page"
			id="dashboard-open_registration_page">Let's get Sunible</button>
	</section>
	<section class="providers container">
		<header>
			<h1>Select providers you’d like to get quotes from</h1>
