					...
					<form id="page-registration-form-register" class="registration_form" name="registration_form">
						<p>
							...
							<span class="field_container">
								<input type="text" onFocus="_gaq.push(['_trackEvent', 'Form Fields', 'Focus', 'Registration First Name', 1, false]);" class="field first_name" name="first_name" placeholder="First Name" required />
								<span class="validation message"></span>
							</span>
							<!-- last name -->
							<span class="field_container">
								<input type="text" onFocus="_gaq.push(['_trackEvent', 'Form Fields', 'Focus', 'Registration Last Name', 1, false]);" class="field last_name" name="last_name" placeholder="Last Name" required />
								<span class="validation message"></span>
							</span>, call me
							<!-- nickname -->
							<span class="field_container">
								<input type="text" onFocus="_gaq.push(['_trackEvent', 'Form Fields', 'Focus', 'Registration Nick Name', 1, false]);" class="field nickname" name="nick_name" placeholder="Nickname" />
								<span class="validation message"></span>
							</span>
							<br/>
							I live at
							<!-- street address -->
							<span class="field_container">
								<input type="text" onFocus="_gaq.push(['_trackEvent', 'Form Fields', 'Focus', 'Registration Street', 1, false]);" class="field street_address" name="street" placeholder="Street Address" required />
								<span class="validation message"></span>
							</span>
							<!-- city -->
							<span class="field_container">
								<input type="text" onFocus="_gaq.push(['_trackEvent', 'Form Fields', 'Focus', 'Registration City', 1, false]);" class="field city" name="city" placeholder="City" required />
								<span class="validation message"></span>
							</span>
							( I
							<!-- property type -->
							...
							<!-- email -->
							<span class="field_container">
								<input type="email" onFocus="_gaq.push(['_trackEvent', 'Form Fields', 'Focus', 'Registration Email', 1, false]);" class="field email" name="email" placeholder="Email" pattern='(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))' required />
								<span class="validation message"></span>
							</span>
							<br/>
							I pay about
							<!-- cost per month -->
							<span class="field_container">
								<input type="text" onFocus="_gaq.push(['_trackEvent', 'Form Fields', 'Focus', 'Registration Utility Bill', 1, false]);" class="field cost_per_month" name="Utility_Bill__c" placeholder="$/month" min="0" required />
								<span class="validation message"></span>
							</span>
							in electricity bills, but wait, that will change when I go solar <img src="/images/smile.png" class="icon smile"/>
							<br/>
							<!-- Terms of Service-->
							<span class="field_container">
